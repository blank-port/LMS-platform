        ...
        <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
            ...
            <div className="flex items-end justify-between border-b border-[var(--border)] pb-8">
                <div>
                    ...
                    <p className="text-gray-500 font-bold mt-2 uppercase text-[10px] tracking-[0.2em]">Dashboard | Education | Quiz | Question Group</p>
                </div>
            </div>
                    ...
                    <div className="bg-[var(--surface)] rounded-[2rem] border border-[var(--border)] p-8 shadow-sm">
                        ...
                        <form onSubmit={handleSave} className="space-y-6">
                            ...
                            <button type="submit" className="w-full h-12 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-all font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2">
                                <PlusIcon className="w-4 h-4" /> Save Group
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div className="lg:col-span-3">
                    <div className="bg-[var(--surface)] rounded-[2rem] border border-[var(--border)] overflow-hidden shadow-sm">
                        <div className="p-8 border-b border-[var(--border)] flex items-center justify-between">
                            <h2 className="text-sm font-black text-[var(--text-main)] uppercase tracking-widest">Active Question Groups</h2>
                        </div>
                                ...
                                <tbody>
                                    {groups.map((group, idx) => (
                                        <tr key={group._id} className="hover:bg-[var(--background)]/20 transition-colors">
                                            ...
                                            <td className="px-8 py-5 text-xs font-bold text-[var(--text-main)] border-b border-[var(--border)]/50 uppercase tracking-tight">{group.name}</td>
                                            <td className="px-8 py-5 border-b border-[var(--border)]/50">
                                                <div className="flex items-center gap-2">
                                                    <button className="p-2 bg-indigo-600/10 text-indigo-400 rounded-lg hover:bg-indigo-600 hover:text-white transition-all">
                                                        <PencilIcon className="w-4 h-4" />
                                                    </button>
                                                    <button className="p-2 bg-rose-600/10 text-rose-400 rounded-lg hover:bg-rose-600 hover:text-white transition-all">
                                    ...
                                    {groups.length === 0 && (
                                        <tr>
                                            <td colSpan="3" className="px-8 py-10 text-center text-xs font-bold text-gray-500 uppercase">No Intellectual Sectors Mapped</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
