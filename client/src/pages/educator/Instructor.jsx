...
const Instructor = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] instructor-theme animate-fade-in relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-20 right-0 h-80 w-80 rounded-full bg-[var(--primary)]/10 blur-[110px]" />
        <div className="absolute bottom-0 left-0 h-72 w-72 rounded-full bg-emerald-500/10 blur-[110px]" />
      </div>
      <Navbar />
      <div className="flex pt-20">
        <SideBar />
        <main className="flex-1 md:ml-[300px] p-6 sm:p-10 lg:p-14 text-[var(--text-main)] overflow-x-hidden relative z-10">
          <Outlet />
        </main>
      </div>
      <Footer />
