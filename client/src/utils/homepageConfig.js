...
export const mergeHomepageConfig = (incoming = {}) => ({
    ...defaultHomepageConfig,
    ...incoming,
    theme: { ...defaultHomepageConfig.theme, ...(incoming.theme || {}) },
    hero: { ...defaultHomepageConfig.hero, ...(incoming.hero || {}) },
    features: {
        ...defaultHomepageConfig.features,
        ...(incoming.features || {}),
        cards: incoming.features?.cards || defaultHomepageConfig.features.cards
    },
    showcase: { ...defaultHomepageConfig.showcase, ...(incoming.showcase || {}) },
    testimonials: {
        ...defaultHomepageConfig.testimonials,
        ...(incoming.testimonials || {}),
        items: incoming.testimonials?.items || defaultHomepageConfig.testimonials.items
    },
    cta: {
        ...defaultHomepageConfig.cta,
        ...(incoming.cta || {}),
        bullets: incoming.cta?.bullets || defaultHomepageConfig.cta.bullets
    }
});
